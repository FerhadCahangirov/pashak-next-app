                    ...
                    <div className="flat-title lg">
                        ...
                        <div>
                            <p className="sub-title text_black-2">
                                Our experienced specialists have selected pharmaceuticals essential for the season.
                            </p>
                            <p className="sub-title text_black-2">
                                Discover a variety of trusted medical products to support healthcare needs.
                            </p>
                        </div>
                    </div>
